...
#ifndef MEETINGSDK_MACOS_SWIFT_H
#define MEETINGSDK_MACOS_SWIFT_H
...
#import <MeetingSDK_macOS/MeetingSDK_macOS.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MeetingSDK_macOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC16MeetingSDK_macOS14AudioCondition")
@interface AudioCondition : CMAudioCondition
...
SWIFT_CLASS("_TtC16MeetingSDK_macOS9AudioInfo")
...
SWIFT_CLASS("_TtC16MeetingSDK_macOS10MeetingSDK")
...
SWIFT_CLASS("_TtC16MeetingSDK_macOS24MeetingSDKDelegateBridge")
...
SWIFT_CLASS("_TtC16MeetingSDK_macOS15SimpleXMLParser")
...
SWIFT_CLASS("_TtC16MeetingSDK_macOS14VideoCondition")
@interface VideoCondition : CMVideoCondition
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Information about one of the Participant’s video sources
SWIFT_CLASS("_TtC16MeetingSDK_macOS9VideoInfo")
